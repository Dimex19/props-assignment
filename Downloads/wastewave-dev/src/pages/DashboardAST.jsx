        ...
        <div className='flex-container ActivitySContainerHeader'>
            ...
            <div className='ActivitySContainer'>
                ...
                <div className='ActivityTable'>
                    <p> <span className="no-underline">Activity 1</span></p>
                    
                    <h2>Waste Scheduling</h2>
                    <p>You scheduled your waste to picked up this week
                    </p>

                </div>

                <div className='ActivityTable'>
                    <p><span className="no-underline">Activity 2</span></p>
                ...
                <div className='ActivityTable'>
                    <p><span className="no-underline">Activity 3</span></p>
